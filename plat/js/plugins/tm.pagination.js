...
angular.module('tm.pagination', []).directive('tmPagination', [function () {
    return {
        ...
        '<div class="col-sm-8 pull-left"><ul class="pagination " ng-show="conf.totalItems > 0">' +
        ...
        '</ul></div>' +
        '<div class="page-total col-sm-3 pull-right hidden-xs" ng-show="conf.totalItems > 0">' +
        ...
        '</div>' +
        '<div class="no-items" ng-show="conf.totalItems <= 0" style="width:100%;overflow:hidden;text-align:center">暂无数据</div>' +
        '</div>',
        replace: true,
        scope: {
            conf: '='
